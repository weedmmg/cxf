...
public class DateUtil {
  ...
  final private static long[] lunarInfo = new long[] {0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260,
      0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x1d255,
      0x0b540, 0x0d6a0, 0x0ada2, 0x095b0, 0x14977, 0x04970, 0x0a4b0, 0x0b4b5, 0x06a50, 0x06d40,
      ...
      0x0d250, 0x0d558, 0x0b540, 0x0b5a0, 0x195a6, 0x095b0, 0x049b0, 0x0a974, 0x0a4b0, 0x0b27a,
      0x06a50, 0x06d40, 0x0af46, 0x0ab60, 0x09570, 0x04af5, 0x04970, 0x064b0, 0x074a3, 0x0ea50,
      0x06b58, 0x055c0, 0x0ab60, 0x096d5, 0x092e0, 0x0c960, 0x0d954, 0x0d4a0, 0x0da50, 0x07552,
      ...
      0x0a6e6, 0x0a4e0, 0x0d260, 0x0ea65, 0x0d530, 0x05aa0, 0x076a3, 0x096d0, 0x04bd7, 0x04ad0,
  ...
  public static String date2Str(Date date, String pattern) {
    ...
    /*
     * if (date == null) { return null; } SimpleDateFormat sdf = new SimpleDateFormat(); if
     * (AppUtils.isEmpty(pattern)) { sdf.applyPattern(pattern); } else {
  ...
  public enum DateStyle {
    ...
    MM_DD("MM-dd"), YYYY_MM("yyyy-MM"), YYYYMM("yyyyMM"), YYYY_MM_DD("yyyy-MM-dd"), MM_DD_HH_MM(
        "MM-dd HH:mm"), MM_DD_HH_MM_SS("MM-dd HH:mm:ss"), YYYY_MM_DD_HH_MM("yyyy-MM-dd HH:mm"), YYYY_MM_DD_HH_MM_SS(
        "yyyy-MM-dd HH:mm:ss"),

    MM_DD_EN("MM/dd"), YYYY_MM_EN("yyyy/MM"), YYYY_MM_DD_EN("yyyy/MM/dd"), MM_DD_HH_MM_EN(
        "MM/dd HH:mm"), MM_DD_HH_MM_SS_EN("MM/dd HH:mm:ss"), YYYY_MM_DD_HH_MM_EN("yyyy/MM/dd HH:mm"), YYYY_MM_DD_HH_MM_SS_EN(
        "yyyy/MM/dd HH:mm:ss"),
  ...
  public static long getUnixTimestap(Date date) throws ParseException {
    Timestamp appointTime =
        Timestamp.valueOf(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(date));
  ...
  public static int getRestDay(Date date, Date endDate) {
    ...
    long day =
        date.getTime() / (24 * 60 * 60 * 1000) - endDate.getTime() / (24 * 60 * 60 * 1000) - 1;
    return (int) day;
  }
  ...
  public static void main(String[] arg) throws ParseException {
    ...
    Date myDate = StringToDate("201712152311314", "yyyyMMddHHmmss");
    Long myDateLong = DateUtil.getUnixTimestap(myDate);

    System.out.println(myDateLong + "::" + myDate.getHours());
    System.out.println(getDateFormat(FORMAT_YYYY_MM_DD).format(
        StringToDate("2015年04月30日", FORMAT_YYYYMMDD)));

    /*
     * Date myDate = StringToDate("2016-02-28 08", "yyyy-MM-dd HH"); Long myDateLong =
     * DateUtil.getUnixTimestap(myDate); Date myDate2 = StringToDate("2016-02-28 16",
     * "yyyy-MM-dd HH"); Long myDateLong2 = DateUtil.getUnixTimestap(myDate2);
     * System.out.println(myDateLong + "::" + myDateLong2);
     * 
     * int b = dayOfYear(myDate); int b2 = dayOfYear(myDate2); System.out.println("days:" + (b2 -
     * b)); System.out.println("days:" + DateUtil.getRestDay(myDate2, myDate));
     * System.out.println("days:" + DateUtil.getRestDay_old(myDate2, myDate)); /* int dd =
     * DateUtil.getRestDay(DateUtil.conventUnixTimestamp(1456675200)); System.out.println(dd);
     * 
     * Date myDate = StringToDate("2016-03-26 08", "yyyy-MM-dd HH"); Long myDateLong =
     * DateUtil.getUnixTimestap(myDate); Date myDate2 = StringToDate("2016-03-26 16",
     * "yyyy-MM-dd HH"); Long myDateLong2 = DateUtil.getUnixTimestap(myDate2);
     * System.out.println(myDateLong + "::" + myDateLong2);
     * 
     * String nid = "112025";
     ...
     * System.out.println(DateUtil.getInteger(myDate, Calendar.HOUR_OF_DAY)); int das =
     * getRestDay(DateUtil.conventUnixTimestamp(sTime), conventUnixTimestamp(eTime));
     * System.out.println("res Day" + das);
     * 
     * int times = 0; times = Integer.parseInt(nid.substring(nid.length() - 1, nid.length()));
     * System.out.println(times); times += 1; nid = nid.substring(0, nid.length() - 1) + times;
     * System.out.println(nid); Date d = conventUnixTimestamp(eTime); d = addDay(d, 365);
     * 
     * int ds = getRestDay(d); System.out.println("rest d:" + ds); long s = getUnixTimestap(d);
     * System.out.println(s); Date date = new Date(); date.setTime((long) s * 1000);
     * 
