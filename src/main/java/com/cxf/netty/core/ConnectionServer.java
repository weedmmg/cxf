...
public final class ConnectionServer extends NettyTCPServer {
	...
	protected void initOptions(ServerBootstrap b) {
		 ...
		 * 那么现在要介绍的这个坑就是关于Netty里的ChannelOutboundBuffer这个东西的。 这个buffer是用在netty向channel
		...
		b.childOption(ChannelOption.WRITE_BUFFER_WATER_MARK,
				new WriteBufferWaterMark(Integer.valueOf(prop.getProperty("connect-server.low")),
						Integer.valueOf(prop.getProperty("connect-server.high"))));
	}
