...
public class ServerTCPHandler extends ChannelInboundHandlerAdapter {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        Logs.CONN.error(String.format("client caught ex, conn={}", connection));
        Logs.CONN.error(String.format("caught an ex, channel={}, conn={}", ctx.channel(), connection, cause));
        ctx.close();
    }
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        Logs.CONN.debug(String.format("client connected conn={}", ctx.channel()));
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        Logs.CONN.debug(String.format("client disconnected conn={}", connection));
    }
