...
public final class NettyConnection implements Connection, ChannelFutureListener {
	...
	public ChannelFuture send(Object packet, final ChannelFutureListener listener) {
		if (channel.isActive()) {
			...
			/*
			 * if (listener != null) { channel.newPromise() .addListener(listener)
	...
	public void operationComplete(ChannelFuture future) throws Exception {
		if (future.isSuccess()) {
			...
			LOGGER.error("connection send msg error={}, conn={}", future.cause().getMessage(), this);
		}
	}
	...
	public String toString() {
		return "[channel=" + channel + ", context=" + context + ", status=" + status + ", lastReadTime=" + lastReadTime
