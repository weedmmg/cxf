...
public final class SessionContext {
	...
	public String tags;
	public int heartbeat = Integer.parseInt(PropertiesUtil.getValue("heartbeat"));// 10s
	...
	public String toString() {
		...
		return "{" + "osName='" + osName + '\'' + ", osVersion='" + osVersion + '\'' + ", deviceId='" + deviceId + '\''
				+ ", userId='" + userId + '\'' + ", tags='" + tags + '\'' + ", heartbeat=" + heartbeat + '}';
	}
}
